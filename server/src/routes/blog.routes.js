...
import { createBlog, deleteBlog, fetchAllBlogs, fetchBlogsByCategory, fetchBlogsByTitleOrCategory, fetchLatestBlogsOfAuthor, fetchMyBlogs, updateBlogDetails, updateBlogThumbnail, viewBlog } from "../controllers/blog.controller.js";
...
router.route("/view/search").get(fetchBlogsByTitleOrCategory);
router.route("/view/category/:category").get(fetchBlogsByCategory);
router.route("/view/author-blogs/:authorId").get(fetchLatestBlogsOfAuthor);
